...
class Reference(ComputationBuildingBlock):
  ...
  def __eq__(self, other: object) -> bool:
    ...
    # TODO: b/328241949 - Implement equality on `building_block.Reference`;
    # `_name`, `_type_signature`, and `_context` are not considered when
...
class Struct(ComputationBuildingBlock, structure.Struct):
  ...
  def __eq__(self, other: object) -> bool:
    if self is other:
      ...
      return NotImplemented
    # TODO: b/328241949 - Implement equality on `building_block.Struct`;
    # `_container_type` is not considered when determining equality.
...
class CompiledComputation(ComputationBuildingBlock):
  ...
  def __eq__(self, other: object) -> bool:
    if self is other:
      ...
      return NotImplemented
    # TODO: b/328241949 - Implement equality on
    # `building_block.CompiledComputation`; `_name` and `_type_signature` are
    # not considered when determining equality.
    return (self._proto_representation,) == (other._proto_representation,)
